      ...
      steps {
        ...
        sh (returnStdout: false, script: '''
          ...
          for vhost in `cat cmd/*/*.viper.yaml | grep hostname | awk '{print $2}' | sed 's/"//g' | sed 's/\\./-/g'`; do
            ...
            ./apollo-item-config.sh 89089012783789789719823798127398 development appuser-manager-npool-top genesis_app '[{\"ID\":\"7203f5c0-7da9-11ec-a3ee-069013a3cb9a\",\"Name\":\"Genesis Dashboard\",\"Description\":\"Bootstrap dashboard\"},{\"ID\":\"ab4d1208-7da9-11ec-a6ea-fb41bda845cd\",\"Name\":\"Church Dashboard\",\"Description\":\"Church dashboard for platform super user\"}]'
