...
import (
	...
	converter "github.com/NpoolPlatform/appuser-manager/pkg/converter/v2/kyc"

	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/v2/kyc"
...
func (s *Server) CreateKycs(ctx context.Context, in *npool.CreateKycsRequest) (*npool.CreateKycsResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "CreateKycs")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetKycOnly(ctx context.Context, in *npool.GetKycOnlyRequest) (*npool.GetKycOnlyResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "GetKycOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistKyc(ctx context.Context, in *npool.ExistKycRequest) (*npool.ExistKycResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "ExistKyc")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistKycConds(ctx context.Context, in *npool.ExistKycCondsRequest) (*npool.ExistKycCondsResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "ExistKycConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountKycs(ctx context.Context, in *npool.CountKycsRequest) (*npool.CountKycsResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "CountKycs")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteKyc(ctx context.Context, in *npool.DeleteKycRequest) (*npool.DeleteKycResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "DeleteKyc")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
