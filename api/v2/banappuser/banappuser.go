...
import (
	...
	converter "github.com/NpoolPlatform/appuser-manager/pkg/converter/v2/banappuser"
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/v2/banappuser"
...
func (s *Server) CreateBanAppUsers(ctx context.Context, in *npool.CreateBanAppUsersRequest) (*npool.CreateBanAppUsersResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "CreateBanAppUsers")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetBanAppUser(ctx context.Context, in *npool.GetBanAppUserRequest) (*npool.GetBanAppUserResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "GetBanAppUser")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetBanAppUserOnly(ctx context.Context, in *npool.GetBanAppUserOnlyRequest) (*npool.GetBanAppUserOnlyResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "GetBanAppUserOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetBanAppUsers(ctx context.Context, in *npool.GetBanAppUsersRequest) (*npool.GetBanAppUsersResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "GetBanAppUsers")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistBanAppUser(ctx context.Context, in *npool.ExistBanAppUserRequest) (*npool.ExistBanAppUserResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "ExistBanAppUser")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountBanAppUsers(ctx context.Context, in *npool.CountBanAppUsersRequest) (*npool.CountBanAppUsersResponse, error) {
	...
	_, span := otel.Tracer(constant.ServiceName).Start(ctx, "CountBanAppUsers")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
