...
import (
	...
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/appuserextra"
...
func (s *Server) CreateAppUserExtra(ctx context.Context, in *npool.CreateAppUserExtraRequest) (*npool.CreateAppUserExtraResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppUserExtra")
	defer span.End()
	defer func() {
		if err != nil {
...
func (s *Server) CreateAppUserExtras(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppUserExtras")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) UpdateAppUserExtra(ctx context.Context, in *npool.UpdateAppUserExtraRequest) (*npool.UpdateAppUserExtraResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "UpdateAppUserExtra")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserExtra(ctx context.Context, in *npool.GetAppUserExtraRequest) (*npool.GetAppUserExtraResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserExtra")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserExtraOnly(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserExtraOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserExtras(ctx context.Context, in *npool.GetAppUserExtrasRequest) (*npool.GetAppUserExtrasResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserExtras")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppUserExtra(ctx context.Context, in *npool.ExistAppUserExtraRequest) (*npool.ExistAppUserExtraResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppUserExtra")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppUserExtraConds(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppUserExtraConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountAppUserExtras(ctx context.Context, in *npool.CountAppUserExtrasRequest) (*npool.CountAppUserExtrasResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountAppUserExtras")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteAppUserExtra(ctx context.Context, in *npool.DeleteAppUserExtraRequest) (*npool.DeleteAppUserExtraResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteAppUserExtra")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
