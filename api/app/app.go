...
import (
	...
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/app"
...
func (s *Server) CreateApps(ctx context.Context, in *npool.CreateAppsRequest) (*npool.CreateAppsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateApps")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppOnly(ctx context.Context, in *npool.GetAppOnlyRequest) (*npool.GetAppOnlyResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistApp(ctx context.Context, in *npool.ExistAppRequest) (*npool.ExistAppResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistApp")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppConds(ctx context.Context, in *npool.ExistAppCondsRequest) (*npool.ExistAppCondsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountApps(ctx context.Context, in *npool.CountAppsRequest) (*npool.CountAppsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountApps")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteApp(ctx context.Context, in *npool.DeleteAppRequest) (*npool.DeleteAppResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteApp")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
