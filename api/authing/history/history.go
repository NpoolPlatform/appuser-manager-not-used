...
import (
	...
	converter "github.com/NpoolPlatform/appuser-manager/pkg/converter/authing/history"
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/authing/history"
...
func (s *Server) CreateHistory(ctx context.Context, in *npool.CreateHistoryRequest) (*npool.CreateHistoryResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateHistory")
	defer span.End()
	defer func() {
		if err != nil {
...
func (s *Server) CreateHistories(ctx context.Context, in *npool.CreateHistoriesRequest) (*npool.CreateHistoriesResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateHistories")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) UpdateHistory(ctx context.Context, in *npool.UpdateHistoryRequest) (*npool.UpdateHistoryResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "UpdateHistory")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetHistory(ctx context.Context, in *npool.GetHistoryRequest) (*npool.GetHistoryResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetHistory")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetHistoryOnly(ctx context.Context, in *npool.GetHistoryOnlyRequest) (*npool.GetHistoryOnlyResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetHistoryOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistHistory(ctx context.Context, in *npool.ExistHistoryRequest) (*npool.ExistHistoryResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistHistory")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistHistoryConds(ctx context.Context, in *npool.ExistHistoryCondsRequest) (*npool.ExistHistoryCondsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistHistoryConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountHistories(ctx context.Context, in *npool.CountHistoriesRequest) (*npool.CountHistoriesResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountHistories")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteHistory(ctx context.Context, in *npool.DeleteHistoryRequest) (*npool.DeleteHistoryResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteHistory")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
