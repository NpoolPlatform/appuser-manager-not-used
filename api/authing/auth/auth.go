...
import (
	...
	converter "github.com/NpoolPlatform/appuser-manager/pkg/converter/authing/auth"
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/authing/auth"
...
func (s *Server) CreateAuth(ctx context.Context, in *npool.CreateAuthRequest) (*npool.CreateAuthResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAuth")
	defer span.End()
	defer func() {
		if err != nil {
...
func (s *Server) CreateAuths(ctx context.Context, in *npool.CreateAuthsRequest) (*npool.CreateAuthsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAuths")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) UpdateAuth(ctx context.Context, in *npool.UpdateAuthRequest) (*npool.UpdateAuthResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "UpdateAuth")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAuthOnly(ctx context.Context, in *npool.GetAuthOnlyRequest) (*npool.GetAuthOnlyResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAuthOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAuth(ctx context.Context, in *npool.ExistAuthRequest) (*npool.ExistAuthResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAuth")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAuthConds(ctx context.Context, in *npool.ExistAuthCondsRequest) (*npool.ExistAuthCondsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAuthConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountAuths(ctx context.Context, in *npool.CountAuthsRequest) (*npool.CountAuthsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountAuths")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteAuth(ctx context.Context, in *npool.DeleteAuthRequest) (*npool.DeleteAuthResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteAuth")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
