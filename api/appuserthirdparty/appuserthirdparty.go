...
import (
	...
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/appuserthirdparty"
...
func (s *Server) CreateAppUserThirdParty(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppUserThirdParty")
	defer span.End()
	defer func() {
		if err != nil {
...
func (s *Server) CreateAppUserThirdParties(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppUserThirdParties")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) UpdateAppUserThirdParty(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "UpdateAppUserThirdParty")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserThirdParty(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserThirdParty")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserThirdPartyOnly(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserThirdPartyOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserThirdParties(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserThirdParties")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppUserThirdParty(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppUserThirdParty")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppUserThirdPartyConds(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppUserThirdPartyConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountAppUserThirdParties(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountAppUserThirdParties")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteAppUserThirdParty(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteAppUserThirdParty")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
