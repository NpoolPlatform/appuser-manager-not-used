...
import (
	...
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/appcontrol"
...
func (s *Server) CreateAppControl(ctx context.Context, in *npool.CreateAppControlRequest) (*npool.CreateAppControlResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppControl")
	defer span.End()
	defer func() {
		if err != nil {
...
func (s *Server) CreateAppControls(ctx context.Context, in *npool.CreateAppControlsRequest) (*npool.CreateAppControlsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppControls")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) UpdateAppControl(ctx context.Context, in *npool.UpdateAppControlRequest) (*npool.UpdateAppControlResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "UpdateAppControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppControl(ctx context.Context, in *npool.GetAppControlRequest) (*npool.GetAppControlResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppControlOnly(ctx context.Context, in *npool.GetAppControlOnlyRequest) (*npool.GetAppControlOnlyResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppControlOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppControls(ctx context.Context, in *npool.GetAppControlsRequest) (*npool.GetAppControlsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppControls")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppControl(ctx context.Context, in *npool.ExistAppControlRequest) (*npool.ExistAppControlResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppControlConds(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppControlConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountAppControls(ctx context.Context, in *npool.CountAppControlsRequest) (*npool.CountAppControlsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountAppControls")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteAppControl(ctx context.Context, in *npool.DeleteAppControlRequest) (*npool.DeleteAppControlResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteAppControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
