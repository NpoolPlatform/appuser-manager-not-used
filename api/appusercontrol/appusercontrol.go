...
import (
	...
	converter "github.com/NpoolPlatform/appuser-manager/pkg/converter/appusercontrol"
	crud "github.com/NpoolPlatform/appuser-manager/pkg/crud/appusercontrol"
...
func (s *Server) CreateAppUserControl(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppUserControl")
	defer span.End()
	defer func() {
		if err != nil {
...
func (s *Server) CreateAppUserControls(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CreateAppUserControls")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) UpdateAppUserControl(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "UpdateAppUserControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserControl(ctx context.Context, in *npool.GetAppUserControlRequest) (*npool.GetAppUserControlResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserControlOnly(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserControlOnly")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) GetAppUserControls(ctx context.Context, in *npool.GetAppUserControlsRequest) (*npool.GetAppUserControlsResponse, error) {
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "GetAppUserControls")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppUserControl(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppUserControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) ExistAppUserControlConds(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "ExistAppUserControlConds")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) CountAppUserControls(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "CountAppUserControls")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
...
func (s *Server) DeleteAppUserControl(ctx context.Context,
	...
	_, span := otel.Tracer(servicename.ServiceDomain).Start(ctx, "DeleteAppUserControl")
	defer span.End()
	defer func() {
		if err != nil {
			span.SetStatus(scodes.Error, err.Error())
