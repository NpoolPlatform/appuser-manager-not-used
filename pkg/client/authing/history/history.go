...
func CreateHistorys(ctx context.Context, in []*npool.HistoryReq) ([]*npool.History, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.CreateHistorys(ctx, &npool.CreateHistorysRequest{
			Infos: in,
		})
		if err != nil {
			return nil, err
...
func GetHistorys(ctx context.Context, conds *npool.Conds, offset, limit int32) ([]*npool.History, uint32, error) {
	var total uint32
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.GetHistorys(ctx, &npool.GetHistorysRequest{
			Conds:  conds,
			Limit:  limit,
			Offset: offset,
		})
...
func CountHistorys(ctx context.Context, conds *npool.Conds) (uint32, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.CountHistorys(ctx, &npool.CountHistorysRequest{
			Conds: conds,
		})
		if err != nil {
			return nil, err
