...
func CreateBanAppV2(ctx context.Context, in *npool.BanApp) (*npool.BanAppRes, error) {
	...
	return info.(*npool.BanAppRes), nil
}

func CreateBanAppsV2(ctx context.Context, in []*npool.BanApp) ([]*npool.BanAppRes, error) {
	...
	return infos.([]*npool.BanAppRes), nil
}

func UpdateBanAppV2(ctx context.Context, in *npool.BanApp) (*npool.BanAppRes, error) {
	info, err := doBanApp(ctx, func(_ctx context.Context, cli npool.AppUserManagerBanAppClient) (cruder.Any, error) {
...
func GetBanAppV2(ctx context.Context, id string) (*npool.BanAppRes, error) {
	info, err := doBanApp(ctx, func(_ctx context.Context, cli npool.AppUserManagerBanAppClient) (cruder.Any, error) {
...
func GetBanAppOnlyV2(ctx context.Context, conds *npool.Conds) (*npool.BanAppRes, error) {
	info, err := doBanApp(ctx, func(_ctx context.Context, cli npool.AppUserManagerBanAppClient) (cruder.Any, error) {
...
func GetBanAppsV2(ctx context.Context, conds *npool.Conds) ([]*npool.BanAppRes, error) {
	infos, err := doBanApp(ctx, func(_ctx context.Context, cli npool.AppUserManagerBanAppClient) (cruder.Any, error) {
...
func DeleteBanAppV2(ctx context.Context, id string) (*npool.BanAppRes, error) {
	infos, err := doBanApp(ctx, func(_ctx context.Context, cli npool.AppUserManagerBanAppClient) (cruder.Any, error) {
