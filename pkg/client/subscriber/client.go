...
func CreateSubscriberes(ctx context.Context, in []*npool.SubscriberReq) ([]*npool.Subscriber, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.CreateSubscriberes(ctx, &npool.CreateSubscriberesRequest{
			Infos: in,
		})
		if err != nil {
			return nil, err
	...
	return infos.([]*npool.Subscriber), nil
}
...
func GetSubscriberOnly(ctx context.Context, conds *npool.Conds) (*npool.Subscriber, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.GetSubscriberOnly(ctx, &npool.GetSubscriberOnlyRequest{
			Conds: conds,
		})
		if err != nil {
			return nil, err
...
func ExistSubscriber(ctx context.Context, id string) (bool, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.ExistSubscriber(ctx, &npool.ExistSubscriberRequest{
			ID: id,
		})
		if err != nil {
			return nil, err
...
func ExistSubscriberConds(ctx context.Context, conds *npool.Conds) (bool, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.ExistSubscriberConds(ctx, &npool.ExistSubscriberCondsRequest{
			Conds: conds,
		})
		if err != nil {
			return nil, err
...
func CountSubscriberes(ctx context.Context, conds *npool.Conds) (uint32, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ManagerClient) (cruder.Any, error) {
		resp, err := cli.CountSubscriberes(ctx, &npool.CountSubscriberesRequest{
			Conds: conds,
		})
		if err != nil {
			return nil, err
