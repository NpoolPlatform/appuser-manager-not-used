...
func Create(ctx context.Context, in *npool.BanApp) (*ent.BanApp, error) {
	var info *ent.BanApp
	var err error
...
func CreateBulk(ctx context.Context, in []*npool.BanApp) ([]*ent.BanApp, error) {
	rows := []*ent.BanApp{}
	var err error
...
func Update(ctx context.Context, in *npool.BanApp) (*ent.BanApp, error) {
	var info *ent.BanApp
	var err error
