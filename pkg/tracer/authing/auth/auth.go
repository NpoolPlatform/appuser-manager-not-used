...
func trace(span trace1.Span, in *npool.AuthReq, index int) trace1.Span {
	span.SetAttributes(
...
func Trace(span trace1.Span, in *npool.AuthReq) trace1.Span {
...
func TraceMany(span trace1.Span, infos []*npool.AuthReq) trace1.Span {
